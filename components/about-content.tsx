...
function OriginHero() {
  ...
  const line1 = "We were".split(" ");
  const line2 = "you".split(" ");

  return (
    <section
      ref={ref}
      className="relative overflow-hidden border-b border-border bg-background pt-32 pb-16 lg:pt-44 lg:pb-24"
    >
      <motion.div
        style={{ y: imageY }}
      ...
      <div className="mx-auto w-full max-w-7xl px-6">
        ...
        >
          Before JDT was a studio, we were the brand searching for designers,
          printers and talent who could keep up with our imagination. So we
          built the partner we always wished we had.
        </motion.p>
      </div>
    </section>
  );
      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="mb-12 flex flex-col gap-3">
          ...
          <p className="max-w-xl text-pretty text-base leading-relaxed text-muted-foreground">
            We spent years on your side of the table, hunting for people who
            could keep up. Here&apos;s what we kept running into, and what we
            built JDT to be instead.
          </p>
        </div>
  ...
  return (
    <span className="mr-[0.25em] inline-block">
      <motion.span
        ...
        className={
          isAccent
            ? "font-serif italic font-normal text-silver-bright"
            : "text-foreground"
        }
      >
        {word}
...
const values = [
  {
    ...
    body: "We start from what's impossible. The brief is a floor, never a ceiling.",
  },
  {
    icon: Flame,
    title: "Built for the impossible",
    body: "The jobs other studios turn down, are the ones we get excited about.",
  },
  {
    icon: InfinityIcon,
    title: "We do it for you",
    body: "Your vision, fully owned end to end. Print, people and dev work under one relentless team.",
  },
];
          ...
          {values.map((value, i) => (
            ...
            >
              <span className="flex size-12 items-center justify-center rounded-full border border-border bg-secondary transition-transform group-hover:scale-110">
                <value.icon
                  className="size-5 text-silver-bright"
                  aria-hidden="true"
                />
              </span>
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          <h2 className="max-w-3xl text-balance font-sans text-3xl font-semibold tracking-tight text-foreground sm:text-4xl lg:text-5xl">
            ...
            <span className="block font-serif italic font-normal text-silver-bright">
              said no to.
            </span>
          </h2>
